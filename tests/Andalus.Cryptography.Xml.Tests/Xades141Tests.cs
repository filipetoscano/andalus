...
public class Xades141Tests
{
    ...
    /// <summary />
    public Xades141Tests( Fixture fixture )
    {
        _f = fixture;
    ...
    public void BuildXadesObject_Ok( KeyType keyType )
    {
        ...
        var elem = Xades141.BuildXadesObject( doc, b.Certificate );
    ...
    public void Enveloped_Ok( XmlCanonicalization canon, XmlCanonicalization? xades )
    {
        ...
        var options = new XmlDigSigOptions
        {
            ...
            Profile = SignatureProfile.Xades141,
    ...
    private static void AssertXadesStructure( XmlDocument signedDoc )
    {
        ...
        // QualifyingProperties (still in x132 namespace) must be present with correct Target
        ...
        // xades:SignedProperties must be present (still in x132 namespace)
        ...
        // V2 elements are in x141 namespace
        Assert.NotNull( sp.SelectSingleNode( "x132:SignedSignatureProperties/x141:SigningCertificateV2", XmlNs.Manager ) );
        Assert.NotNull( sp.SelectSingleNode( "x132:SignedSignatureProperties/x141:SigningCertificateV2/x141:Cert/x141:IssuerSerialV2", XmlNs.Manager ) );
    }
}
